...
class GitProvider(ABC):
    ...
    def get_user_description(self, *, fallback_user_title: bool = False) -> str:
        description = (self.get_pr_description_full() or "").strip()
        # if the existing description wasn't generated by the pr-agent, just return it as-is
        if not description.startswith("## PR Type"):
            # if there is a user title, and there is no existing user description, return the title as the description
            if fallback_user_title and not description:
                description = self.pr.title
            return description
